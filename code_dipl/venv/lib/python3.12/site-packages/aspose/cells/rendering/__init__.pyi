...
class DataBarRenderMode:
    '''Represents the DataBar render mode.'''
    
    BACKGROUND_COLOR : DataBarRenderMode
    '''Renders the DataBar using background color.'''
    IMAGE : DataBarRenderMode
    '''Renders the DataBar as image.'''
