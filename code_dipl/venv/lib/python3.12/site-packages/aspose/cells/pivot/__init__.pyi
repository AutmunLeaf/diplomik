...
class PivotAreaCollection:
    ...
    def add_pivot_area(self, pivot_area : aspose.cells.pivot.PivotArea) -> int:
        '''Adds pivot area into this collection.
        
        :returns: index of the added pivot area in this collection'''
        raise NotImplementedError()
...
class PivotField:
    ...
    @overload
    def group_by(self, groups : List[aspose.cells.pivot.PivotGroupByType], interval : float, new_field : bool) -> None:
        '''Automatically group the field with internal
    ...
    @overload
    def group_by(self, is_auto_start : bool, start : datetime, is_auto_end : bool, end : datetime, groups : List[aspose.cells.pivot.PivotGroupByType], interval : float, first_as_new_field : bool) -> bool:
        '''Group the file by the date group types.
        
        :param is_auto_start: Indicates whether to auto detect the start date time value.
        :param start: The start datetime
        :param is_auto_end: Indicates whether to auto detect the end date time value.
        :param end: The end of datetime
        :param groups: Group types
        :param interval: The interval
        :param first_as_new_field: Indicates whether adding a new field to the pivottable.
    ...
    @overload
    def group_by(self, is_auto_start : bool, start : float, is_auto_end : bool, end : float, interval : float, new_field : bool) -> bool:
        '''Group the file by number.
        
        :param is_auto_start: Indicates whether to auto detect the start value.
        :param start: The start value
        :param is_auto_end: Indicates whether to auto detect the end value.
        :param end: The end of value
        :param interval: The interval
        :param new_field: Indicates whether adding a new field to the pivottable
        :returns: False means this field could not be grouped by date time.'''
    ...
    def get_max_value(self) -> aspose.cells.CellValue:
        '''Gets the max value of this field.'''
        raise NotImplementedError()
    
    def get_min_value(self) -> aspose.cells.CellValue:
        '''Gets the max value of this field.'''
        raise NotImplementedError()
...
class PivotTable:
    ...
    def get_button_area(self, axis_type : aspose.cells.pivot.PivotFieldType) -> aspose.cells.CellArea:
    ...
    @property
    def pivot_table_style(self) -> aspose.cells.tables.TableStyle:
        '''Gets :py:attr:`aspose.cells.pivot.PivotTable.TableStyle` settings of this pivot table.'''
        raise NotImplementedError()
    
    @pivot_table_style.setter
    def pivot_table_style(self, value : aspose.cells.tables.TableStyle) -> None:
        '''Gets :py:attr:`aspose.cells.pivot.PivotTable.TableStyle` settings of this pivot table.'''
        raise NotImplementedError()
    ...
    @property
    def top_right_area(self) -> aspose.cells.CellArea:
        '''Represents the blank area at the top-right of the PivotTable (top-left for RTL sheets).'''
        raise NotImplementedError()
    
    @property
    def filter_area(self) -> aspose.cells.CellArea:
...
class PivotTableCollection:
    ...
    def __getitem__(self, key : int) -> aspose.cells.pivot.PivotTable:
