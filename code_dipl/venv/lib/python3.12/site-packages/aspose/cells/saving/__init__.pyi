...
class EbookSaveOptions(aspose.cells.HtmlSaveOptions):
    ...
    @property
    def export_named_range_anchors(self) -> bool:
        '''Indicates whether to export anchor elements for named ranges when saving as HTML.
        Default value is true.'''
        raise NotImplementedError()
    
    @export_named_range_anchors.setter
    def export_named_range_anchors(self, value : bool) -> None:
        '''Indicates whether to export anchor elements for named ranges when saving as HTML.
        Default value is true.'''
        raise NotImplementedError()
    
    @property
    def data_bar_render_mode(self) -> aspose.cells.rendering.DataBarRenderMode:
        '''Represents the mode of how to render DataBar when converting Excel files to html files.
        Default value is :py:attr:`aspose.cells.rendering.DataBarRenderMode.BACKGROUND_COLOR`.'''
        raise NotImplementedError()
    
    @data_bar_render_mode.setter
    def data_bar_render_mode(self, value : aspose.cells.rendering.DataBarRenderMode) -> None:
        '''Represents the mode of how to render DataBar when converting Excel files to html files.
        Default value is :py:attr:`aspose.cells.rendering.DataBarRenderMode.BACKGROUND_COLOR`.'''
        raise NotImplementedError()
