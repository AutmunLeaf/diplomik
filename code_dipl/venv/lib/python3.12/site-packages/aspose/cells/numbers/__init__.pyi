...
class NumbersLoadOptions(aspose.cells.LoadOptions):
    ...
    @property
    def preserve_table_name(self) -> bool:
        '''Indicates whether to preserve table names when importing from Numbers.'''
        raise NotImplementedError()
    
    @preserve_table_name.setter
    def preserve_table_name(self, value : bool) -> None:
        '''Indicates whether to preserve table names when importing from Numbers.'''
        raise NotImplementedError()
    ...
    def load_table_type(self, value : aspose.cells.numbers.LoadNumbersTableType) -> None:
        '''Gets and sets the type of loading multiple tables in one worksheet.'''
        raise NotImplementedError()
