...
class Chart:
    ...
    def move(self, top_row : int, left_column : int, bottom_row : int, right_column : int) -> None:
        '''Moves the chart to a specified location.
        
        :param left_column: Upper left column index.
        :param top_row: Upper left row index.
        :param right_column: Lower right column index
        :param bottom_row: Lower right row index'''
        raise NotImplementedError()
...
class ChartCollection:
    ...
    @overload
    def add(self, type : aspose.cells.charts.ChartType, top_row : int, left_column : int, bottom_row : int, right_column : int) -> int:
    ...
    def __getitem__(self, key : int) -> aspose.cells.charts.Chart:
        '''Gets the :py:class:`aspose.cells.charts.Chart` element at the specified index.'''
        raise NotImplementedError()
...
class ChartDataValue:
    ...
    @property
    def value_type(self) -> aspose.cells.CellValueType:
...
class Series:
    ...
    @property
    def cached_category_values(self) -> List[Any]:
        '''Gets the cached category values for the series'''
        raise NotImplementedError()
    
    @property
    def point_values(self) -> List[aspose.cells.charts.ChartDataValue]:
        '''Gets the actual values that are used to plot every point
        of this series in the chart.'''
        raise NotImplementedError()
    
    @property
    def category_values(self) -> List[List[aspose.cells.charts.ChartDataValue]]:
...
class SeriesCollection:
    ...
    @overload
    def add(self, data_area : str, is_vertical : bool) -> int:
        '''Adds the :py:class:`aspose.cells.charts.Series` collection to a chart.
        
        :param data_area: Specifies values from which to plot the data series
        :param is_vertical: Specifies whether to plot the series from a range of cell values by row or by column.
        If true, :py:class:`aspose.cells.charts.Series` will be added column by column
    ...
    def change_colors(self, type : aspose.cells.charts.ChartColorPaletteType) -> None:
    ...
    def __getitem__(self, key : int) -> aspose.cells.charts.Series:
        '''Gets the :py:class:`aspose.cells.charts.Series` element at the specified index.'''
        raise NotImplementedError()
...
class SparklineCollection:
    ...
    def remove_sparkline(self, o : aspose.cells.charts.Sparkline) -> None:
...
class SparklineGroup:
    ''':py:class:`aspose.cells.charts.Sparkline` is organized into a sparkline group.
...
class SparklineGroupCollection:
    ...
    def add(self, type : aspose.cells.charts.SparklineType, data_range : str, is_vertical : bool, location_range : aspose.cells.CellArea) -> int:
        '''Adds an :py:class:`aspose.cells.charts.SparklineGroup` with some :py:class:`aspose.cells.charts.Sparkline` to the collection.
...
class ChartColorPaletteType:
    ...
    MONOCHROMATIC_PALETTE1 : ChartColorPaletteType
    '''accent1 theme color gradient, dark to light.'''
    MONOCHROMATIC_PALETTE2 : ChartColorPaletteType
    '''accent2 theme color gradient, dark to light.'''
    MONOCHROMATIC_PALETTE3 : ChartColorPaletteType
    '''accent3 theme color gradient, dark to light.'''
    MONOCHROMATIC_PALETTE4 : ChartColorPaletteType
    '''accent4 theme color gradient, dark to light.'''
    MONOCHROMATIC_PALETTE5 : ChartColorPaletteType
    '''accent5 theme color gradient, dark to light.'''
    MONOCHROMATIC_PALETTE6 : ChartColorPaletteType
    '''accent6 theme color gradient, dark to light.'''
    MONOCHROMATIC_PALETTE7 : ChartColorPaletteType
    '''accent7 theme color gradient.'''
    MONOCHROMATIC_PALETTE8 : ChartColorPaletteType
    '''accent1 theme color gradient, light to dark.'''
    MONOCHROMATIC_PALETTE9 : ChartColorPaletteType
    '''accent2 theme color gradient, light to dark.'''
    MONOCHROMATIC_PALETTE10 : ChartColorPaletteType
    '''accent3 theme color gradient, light to dark.'''
    MONOCHROMATIC_PALETTE11 : ChartColorPaletteType
    '''accent4 theme color gradient, light to dark.'''
    MONOCHROMATIC_PALETTE12 : ChartColorPaletteType
    '''accent5 theme color gradient, light to dark.'''
    MONOCHROMATIC_PALETTE13 : ChartColorPaletteType
