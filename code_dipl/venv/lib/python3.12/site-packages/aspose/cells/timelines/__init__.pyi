...
class Timeline:
    ...
    @property
    def show_selection_label(self) -> bool:
        '''Indicates whether to display the selction label.'''
        raise NotImplementedError()
    
    @show_selection_label.setter
    def show_selection_label(self, value : bool) -> None:
        '''Indicates whether to display the selction label.'''
        raise NotImplementedError()
    
    @property
    def show_time_level(self) -> bool:
        '''Indicates whether to display the time level.'''
        raise NotImplementedError()
    
    @show_time_level.setter
    def show_time_level(self, value : bool) -> None:
        '''Indicates whether to display the time level.'''
        raise NotImplementedError()
    ...
    def show_horizontal_scrollbar(self, value : bool) -> None:
        '''Indicates whether to display the horizontal ccroll bar.'''
        raise NotImplementedError()
    
    @property
    def start_date(self) -> datetime:
        '''Gets and sets the start date of the timespan scrolling position of this :py:class:`aspose.cells.timelines.Timeline`.'''
        raise NotImplementedError()
    ...
    @property
    def current_level(self) -> aspose.cells.timelines.TimelineLevelType:
        '''The current time level of the Timeline.'''
        raise NotImplementedError()
    
    @current_level.setter
    def current_level(self, value : aspose.cells.timelines.TimelineLevelType) -> None:
        '''The current time level of the Timeline.'''
        raise NotImplementedError()
    
    @property
    def selection_level(self) -> aspose.cells.timelines.TimelineLevelType:
        '''Gets and sets the time level at which the current selection was made for the Timeline.'''
        raise NotImplementedError()
    
    @selection_level.setter
    def selection_level(self, value : aspose.cells.timelines.TimelineLevelType) -> None:
        '''Gets and sets the time level at which the current selection was made for the Timeline.'''
        raise NotImplementedError()
    ...
    def shape(self) -> aspose.cells.drawing.TimelineShape:
        '''Returns the :py:class:`aspose.cells.drawing.TimelineShape` object associated with this Timeline.'''
        raise NotImplementedError()
...
class TimelineCollection:
    '''Specifies the collection of all the :py:class:`aspose.cells.timelines.Timeline` objects on the worksheet.
...
class TimelineLevelType:
    '''Represents the level type of :py:class:`aspose.cells.timelines.Timeline`'''
    
    YEAR : TimelineLevelType
    '''Year'''
    QUARTER : TimelineLevelType
    '''Quarter'''
    MONTH : TimelineLevelType
    '''Month'''
    DAY : TimelineLevelType
    '''Day'''
