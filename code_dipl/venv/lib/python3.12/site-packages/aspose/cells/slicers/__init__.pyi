...
class Slicer:
    ...
    @property
    def sort_order_type(self) -> aspose.cells.SortOrder:
        '''Indicates the type of sorting items.'''
        raise NotImplementedError()
    
    @sort_order_type.setter
    def sort_order_type(self, value : aspose.cells.SortOrder) -> None:
        '''Indicates the type of sorting items.'''
        raise NotImplementedError()
    ...
    @show_missing.setter
    def show_missing(self, value : bool) -> None:
        '''Indicates whether to show items deteleted from the data source.'''
        raise NotImplementedError()
    
    @property
    def show_type_of_items_with_no_data(self) -> aspose.cells.slicers.ItemsWithNoDataShowMode:
        '''Indicates whether to show items deteleted from the data source.'''
        raise NotImplementedError()
    
    @show_type_of_items_with_no_data.setter
    def show_type_of_items_with_no_data(self, value : aspose.cells.slicers.ItemsWithNoDataShowMode) -> None:
        '''Indicates whether to show items deteleted from the data source.'''
        raise NotImplementedError()
    ...
    def parent(self) -> aspose.cells.Worksheet:
        '''Returns the :py:attr:`aspose.cells.slicers.Slicer.worksheet` object which contains this slicer. Read-only.'''
        raise NotImplementedError()
    ...
    @show_caption.setter
    def show_caption(self, value : bool) -> None:
        '''Indicates whether the header of the slicer is visible.
        The default value is true'''
        raise NotImplementedError()
    ...
    def number_of_columns(self) -> int:
        '''Returns the number of columns in the slicer.
    ...
    def column_width(self) -> float:
        '''Returns the width of each column in the slicer in unit of points.'''
        raise NotImplementedError()
    ...
    def row_height_pixel(self) -> int:
        '''Returns the height of each row in the specified slicer, in unit of pixels.'''
        raise NotImplementedError()
    ...
    def row_height(self) -> float:
        '''Returns the height of each row in the specified slicer in unit of points.'''
        raise NotImplementedError()
...
class ItemsWithNoDataShowMode:
    '''Represent the type how to show items with no data for slicer.'''
    
    NONE : ItemsWithNoDataShowMode
    '''Hide items with no data.'''
    LAST : ItemsWithNoDataShowMode
    '''Show items with no data last.'''
    NATURAL : ItemsWithNoDataShowMode
